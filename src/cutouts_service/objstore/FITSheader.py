...
class FITSheaderFromS3:
    ...
    def __getData(self, length, start_pos):
        ...
        obj_content = self.client.get_object(
            Bucket=self.bucket, Key=self.key, Range=ranges
        )["Body"].read()
...
if __name__ == "__main__":
    hdr_obj = FITSheaderFromURL(
        "https://projects.pawsey.org.au/dc2/sky_full_v2.fits?AWSAccessKeyId=acf82f0144c0414f864550c298d8c4d6&Signature=XW%2B%2FqKpfNzcrjBFjuNfdq2unJpY%3D&Expires=1657502744"
    )
